...
def calculate_stats(seq_lens, gc_cont):
    ...
    # np.where returns a tuple of arrays; take the first index of the first array.
    # `int(array_of_one)` was a DeprecationWarning on numpy 1.25+ and is a hard
    # TypeError on numpy 2.x, so this breaks the moment the container is rebuilt.
